...
>
  ...
  />
      ...
      <h1 id="words" className=" text-white text-center font-sans md:text-6xl text-3xl">My Work</h1>
    <section className="work-grid-section ">
      ...
      <div className="work-grid-container">
        <div className="work-box pos-down img-news">
          ...
          <Link to="/work">
            {" "}
            <span className="box-link">VIEW PAGE &#8599;</span>
          </Link>
        </div>
        <div className="work-box pos-up img-blog">
          <h3>BLOG</h3>
          <span className="box-link">Blog, Resources &#8599;</span>
        </div>
        <div className="work-box pos-down img-work">
          <h3>MEDIA</h3>
          <span className="box-link">Audio and Video &#8599;</span>
        </div>
        <div className="work-box pos-up img-talks">
          <h3>PUBLICATIONS AND PRESENTATIONS</h3>
          <span className="box-link">View Publications &#8599;</span>
        </div>
      </div>
    </section>
	</div>
